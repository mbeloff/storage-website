<template>
  <div class="container text-justify">
    ...
    <p>
      Gabba Storage delivers a storage unit right to your door, pack and lock up
      the unit at your leisure and when you're ready we'll collect it to store
      securely on our premises for as long as you like. You're free to access
      your storage unit at our site as often as you please, or we can drop it
      back to you. Or if you prefer you can keep the unit at your location and
      we'll simply collect the empty unit when you no longer need it.
    </p>
    <p>
    ...
    <div class="row">
      <div class="col-12">
        ...
        <p>
          After you have packed your storage box, we collect it to store at our
        ...
        <p>
          ...
          access to your stuff and a secure place to keep them out of the
